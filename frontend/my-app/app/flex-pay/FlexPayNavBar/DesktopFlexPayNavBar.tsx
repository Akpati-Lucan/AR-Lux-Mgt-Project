...
const FlexPayNavBar = () => {
  return (
    <div className='h-screen w-64 bg-gray-900 text-purple-400 flex flex-col gap-4 p-6 text-lg'>
            <Link href="/flex-pay" className="hover:text-white">Solutions</Link>
            ...
            <Link href="/flex-pay" className="hover:text-white">Technical</Link>
            ...
            <Link href="/flex-pay" className="hover:text-white">About Flex Pay</Link>
